package com.war_against_covid_19.coral.recordhelper
 ...
 *@description :仅录制音频的类
 */
class RecordHelper private constructor() {
    ...
    companion object {
        ...
        private val PCMPath =
            Environment.getExternalStorageDirectory().path.toString() + "/zzz/RawAudio.pcm"
        private val WAVPath =
            Environment.getExternalStorageDirectory().path.toString() + "/zzz/FinalAudio.wav"

        //double check单例
        val instance: RecordHelper by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) {
            RecordHelper()
        }
    }
